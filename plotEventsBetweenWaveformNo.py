...
from functions.fun_removeOutsideWaveformNo import removeOutsideWaveformNo
...
# Remove data outside of dateInterva
print(df_SWfm)
df_SWfm = removeOutsideWaveformNo(df_SWfm,NoRangeStart,NoRangeEnd)
print('keeping events only between',NoRangeStart,' to ',NoRangeEnd)
print(df_SWfm)
