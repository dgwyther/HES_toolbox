...
# global defns
title = 'Captain Cook Bridge (Southbound): Halving Joint 3 Monitoring Project'
#author = 'Report issued: '+f"{datetime.datetime.now():%d-%b-%Y}"
author = 'Diagnostic report'
logo_path = 'assets/logo.png'
output_name = str(f"{datetime.datetime.now():%Y_%m_%d}"+'.sb.diagnostics.draft.pdf')
...
#############################################################
NoTimeSeriesDisplacedMinMaxAvg=0
