...
for ii in range(1,NoTimeSeriesSubplots+1):
    generateTimeSeriesSubplots(df_SS,"TIMESTAMP",eval('timeseries_plots'+str(ii)),nRows,nCols,'test_timeseriesSubplots'+str(ii)+'.png','save')

for ii in range(1,NoTimeSeriesDisplaced+1):
    generateTimeSeriesDisplaced(df_SS,"TIMESTAMP",timeseries_plots_displaced1,dispFactor,dispRef,'test_timeseriesDisplaced'+str(ii)+'.png','save')
